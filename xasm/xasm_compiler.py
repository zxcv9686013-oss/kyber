...
VALID_TARGETS = {"cpu", "gpu", "npu", "tpu", "lpu", "cuda"}
TARGET_ALIASES = {
    "cpu": "cpu",
    "gpu": "gpu",
    "cuda": "cuda",
...
def main(argv: List[str]) -> int:
    ...
    ap.add_argument("source", help=".xasm source file")
    ap.add_argument("output", help="destination .obj path")
    ap.add_argument("--nasm", default=None, help="path to nasm executable")
    ap.add_argument("--target", default=None, help="target backend: auto, cpu, gpu, npu, tpu, lpu, cuda")
